...
{*                        <div class="basecamp">
                ...
                <div class="ten columns">
                    <div class="section remove-top remove-bottom">
                        <form action="/user/setting" id="tapForm" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="five columns alpha">
                                    <button type="submit"><span>設定する</span></button>
                                    </div>
...
{*                <div class="five columns offset-by-one">
                    ...
                    <div class="section remove-top">
                        ...
                        hello[at]eleventhedition.com</p>
                        <p><span style="color: #1fb4dd;">Visit:</span><br />
                        Suite 166, Central Chambers<br />
                        11 Bothwell Street<br />
                        Glasgow<br />
                        G2 6LY</p>
                    </div>
